      ...
      <div className="relative z-0 flex flex-col w-full">
        ...
        <div className="flex justify-evenly flex-col md:flex-row mt-6">
          ...
          <div className="md:w-[500px] mt-4 md:mt-8 mx-4 sm:mx-8 flex flex-wrap justify-between">
            <div className="mb-3">
              <h3 className="relative md:-left-4 underline underline-offset-2 md:underline-offset-3 decoration-slate-700 decoration-1 md:decoration-2 font-semibold mb-3 text-2xl md:text-3xl ">
                Front-end
              </h3>
